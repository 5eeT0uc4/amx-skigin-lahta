...
(***********************************************************)
(*  FILE_LAST_MODIFIED_ON: 06/11/2007 AT: 14:46:08         *)
(***********************************************************)
(*  ORPHAN_FILE_PLATFORM: 1                                *)
(***********************************************************)
(*  FILE REVISION: Rev 2                 cwl               *)
(*  REVISION DATE: 06/11/2007  AT: 14:46:08                *)
(*                                                         *)
(*  COMMENTS:                                              *)
...
INTEGER ciMAX_REBOOTS_FOR_INTERNALS = 5
...
DEFINE_FUNCTION REPORT_INTERNALS()
{
    ...
    (* ERROR: Symbol [INTERNAL_THRESHOLD_INDEX_INTERPRETER] not defined*)
...
DEFINE_FUNCTION CHECK_THRESHOLD_SIZE(LONG THRESHOLD_INDEX,LONG SET_VALUE, char DESC[])
{
    ...
    lValue = INTERNAL_THRESHOLD_GET(THRESHOLD_INDEX);
