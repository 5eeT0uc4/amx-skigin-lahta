MODULE_NAME='APC_SW_RACK_PDU' (dev vdvDevice, dev dvDevice, char caHost[])
...
volatile char		m_caDeviceName[30]	= 'APC SWITCHED RACK PDU'
...
define_function fnOnReceive(char in_caData[])
{
    ...
    if(find_string(in_caData, 'American Power Conversion', 1)) {
	m_iOnWork = 1
    }
}
